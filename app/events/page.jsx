      ...
      <main>
        ...
        <section>
          <div className="flex flex-col items-center gap-8 padding-y px-48 max-lg:p-10 font-palanquin text-center text-balance text-black text-lg max-sm:text-base max-sm:leading-7 leading-8">
            <p>
              Namadwaar Singapore organizes a variety of events throughout a
              year such as contests, community events, and celebrations during
              festive occasions, bringing people together in a close-knit space.
            </p>
            <p>
