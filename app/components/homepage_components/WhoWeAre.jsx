    ...
    >
      ...
      <div className='flex flex-col items-start justify-start w-3/5 max-lg:w-full max-lg:items-center'>
        <h1 className='font-caudex text-primary-maroon text-4xl max-md:text-3xl max-md:leading-8 font-bold'> Who we are </h1>
          ...
          Namadwaar Singapore is a registered Hindu society inspired by HH Maharanyam Sri Sri Muralidhara Swamiji established since Nov 8 2012 to help promote Universal Love for the betterment of human race without any social , cultural or geographical barriers. 
          <br/>
          <br/>
